            ...
            <div class="grid">
                ...
                <div class="gridjes1">
                    <div class="product" >
                        ...
                        <div class="gridjes" v-if="json[$route.params.id - 1].type == 'Tripod'">
                            <div>
                    ...
                    <div class="informationert" >
                        <h3 class="productInfoText">Product info</h3>
                        <br>
                        <div v-if="json[$route.params.id - 1].type == 'Tripod'">
                            <h3>Quantity: {{ json[$route.params.id - 1].amount }}</h3>
                            <h3>Max. Length: {{ json[$route.params.id - 1].max_length }}</h3>
                            <h3>Max. Load Weight: {{ json[$route.params.id - 1].max_load_weight }} KG</h3>
                            <h3>Type Tripod: {{ json[$route.params.id - 1].type_tripod }}</h3>
                            <br>
                        ...
                        <div v-else-if="json[$route.params.id - 1].type == 'SD-Card'">
                            <h3>Quantity: {{ json[$route.params.id - 1].amount }}</h3>
                            <h3>Capacity: {{ json[$route.params.id - 1].capacity }}GB</h3>
                            <h3>Max. Read Speed: {{ json[$route.params.id - 1].max_read_speed }}</h3>
                            <h3>Max. Write Speed: {{ json[$route.params.id - 1].max_write_speed }}</h3>
                            <nuxt-link :to="'/shop/' + json[$route.params.id - 1].category + '/' + json[$route.params.id - 1].id" :title="'Shopping Cart Page ' + json[$route.params.id - 1].name" class="noDec">
                                <buyBtn />
                            </nuxt-link>
                        </div>
