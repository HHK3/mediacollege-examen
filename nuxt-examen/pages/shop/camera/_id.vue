    ...
    <div class="mx-auto py-30">
        <section class="sectionert">
                ...
                <div class="grid">
                    ...
                    <h2 class="v-lazy">€{{ json[$route.params.id - 1].price }}</h2>
                    ...
                    <div class="gridjes1">
                        ...
                        <div class="informationert" >
                            ...
                            <h3>Megapixels: {{ json[$route.params.id - 1].megapixels }}MP</h3>
                            <h3>Screen Sensor: {{ json[$route.params.id - 1].screen_sensor }}</h3>
                            <h3>Level Camera: {{ json[$route.params.id - 1].level }}</h3>
                            <br>
